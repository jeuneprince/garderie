...
<html>
	<head>
		<title> Modification d'une gardienne </title>
	</head>
	...
	<body>
		...
		<?php 
			...
			elseif(isset($_POST['idgardiennes']) && isset($_POST['nom']) && isset($_POST['prenom'])&& isset($_POST['session'])&& isset($_POST['trancheage']))
			{
				...
				*/
				$requete = $bddPDO->prepare('UPDATE gardiennes SET nom=:nom, prenom=:prenom, session=:session, trancheage=:trancheage WHERE idgardiennes=:idgardiennes');

				$requete->bindvalue(':idgardiennes', $idgardiennes);
				$requete->bindvalue(':nom', $nom);
				$requete->bindvalue(':prenom', $prenom);
				$requete->bindvalue(':session', $session);
                $requete->bindvalue(':trancheage', $trancheage);
